...
@Component({
  selector: 'app-bride-by-ines',
  templateUrl: './bride-by-ines.component.html',
  styleUrls: ['./bride-by-ines.component.css']
})
export class BrideByInesComponent {
  // NavbarComponent
  src = '../../assets/videos/bride by lobna ben ammar.mp4';
  path = 1;
  // NavbarComponent
  data = [
    ["../../assets/img/bride-by-ahlem-la-maison-lobna-ben-ammar-make-up-by-lobna-4.jpg"],
  ];
  ...
  constructor() {
    ...
    for (let i = 0; i < this.data3.length; i++) {
      for (let j = 0; j <= this.data3[i].length+1; j++) {
